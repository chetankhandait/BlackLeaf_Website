...
//     const prevButton = document.getElementById("keen-slider-prev");
...
//   return (
//     <div>
//       <div className=" mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 px-4 xl:grid-cols-4 gap-6 w-full">
//         <div className="mt-8 flex justify-between w-10 h-10">
//           <button
...
//           <div className="relative mx-auto w-full keen-slider__slide">
//             <a
//               href="#"
