                      ...
                      <div className="shadow p-4 rounded-lg  ">
                        <div className="flex justify-center relative rounded-lg overflow-hidden h-52">
                          <div className="transition-transform duration-500 transform ease-in-out hover:scale-110 w-full">
                            ...
                            <img src="https://images.unsplash.com/photo-1513584684374-8bab748fbf90?q=80&w=2065&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
                          </div>
                          <div className="absolute flex justify-center bottom-0 mb-3">
                            <div className="flex bg-white px-4 py-1 space-x-5 rounded-lg overflow-hidden shadow">
                              <p className="flex items-center font-medium text-black">
                                <IoBedOutline className="w-5 h-5  mr-2" />3 + 1
                              </p>
                              <p className="flex items-center font-medium text-black">
                                <IoBedOutline className="w-5 h-5  mr-2" />2
                              </p>
                              <p className="flex items-center font-medium text-black">
                                <LuBath className="w-5 h-5  mr-2" />3
                              </p>
                            </div>
                          </div>
                          <span className="absolute top-0 left-0 inline-flex mt-3 ml-3 px-3 py-2 rounded-lg z-10 bg-[#111827] text-sm font-medium text-white select-none">
                            Featured
                          </span>
                        </div>
                        <div className="mt-4">
                          ...
                          <p
                            className="mt-2 text-sm text-white line-clamp-1"
                        ...
                        <div className="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
                          <p className="inline-flex flex-col xl:flex-row xl:items-center text-white">
                            <BsHouseDoor className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3  text-white" />
                            <span className="mt-2 xl:mt-0">Condominium</span>
                          </p>
                          <p className="inline-flex flex-col xl:flex-row xl:items-center text-white">
                            <svg
                              className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-white"
                              viewBox="0 0 18 18"
                              fill="none"
                          ...
                          <p className="inline-flex flex-col xl:flex-row xl:items-center text-white">
                            <FaArrowsLeftRight className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3  text-white" />
