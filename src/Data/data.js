const Data = [
  {
    ...
    description:
      "A mini pool villa for a couple who look for a nice and quiet vacation. Located in the Heart of Bang MaKham, local of Koh Samui. The sunset of Bang MaKham will be your best experience of your vacation.",
    guest: "16+",
    owner: "Twesuk",
    ownerImg:
      "https://a0.muscache.com/im/pictures/user/c9d70d6c-f4ec-4438-a065-f47839c203d3.jpg?im_w=240",
    ...
    reviewText: [
      {
        ...
        content:
          "It was really a very nice place, unfortunately just a little away from the shot",
        rating: 5,
      },
      {
        id: 2,
        ...
        content:
          "Very nice guests try to help you in every way, smiling does not leave them the room very clean. The bed is the top of comfort, the details are better than five stars, I highly recommend.",
        rating: 4,
      },
      {
        id: 3,
